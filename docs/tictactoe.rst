...
1. **Starting the game**: Run the game via:
...
3. **Computer response**: After your move, the computer (O in red) will calculate its optimal move and place an O after a brief delay.

4. **Winning**: The first player to align **three of their own pieces** in a row (horizontal, vertical, or diagonal) wins.
